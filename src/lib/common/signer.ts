...
import { Data } from '../generated/credential-templates/template_pb';
 ...
 * @returns {string}
 */
export const computePOIHash = (data: Data): string => createHash('md5').update(data.serializeBinary()).digest('hex');
